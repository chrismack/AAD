...
public class truckCarMatrix extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.option1).setOnDragListener(new truckCarMatrix.dragListener());
        findViewById(R.id.option1).setOnTouchListener(new truckCarMatrix.dragTouchListener());
        findViewById(R.id.option2).setOnDragListener(new truckCarMatrix.dragListener());
        findViewById(R.id.option2).setOnTouchListener(new truckCarMatrix.dragTouchListener());
        findViewById(R.id.option3).setOnDragListener(new truckCarMatrix.dragListener());
        findViewById(R.id.option3).setOnTouchListener(new truckCarMatrix.dragTouchListener());
        findViewById(R.id.option4).setOnDragListener(new truckCarMatrix.dragListener());
        findViewById(R.id.option4).setOnTouchListener(new truckCarMatrix.dragTouchListener());
        findViewById(R.id.option5).setOnDragListener(new truckCarMatrix.dragListener());
        findViewById(R.id.option5).setOnTouchListener(new truckCarMatrix.dragTouchListener());
        findViewById(R.id.option6).setOnDragListener(new truckCarMatrix.dragListener());
        findViewById(R.id.option6).setOnTouchListener(new truckCarMatrix.dragTouchListener());
        findViewById(R.id.option7).setOnDragListener(new truckCarMatrix.dragListener());
        findViewById(R.id.option7).setOnTouchListener(new truckCarMatrix.dragTouchListener());
        findViewById(R.id.option8).setOnDragListener(new truckCarMatrix.dragListener());
        findViewById(R.id.option8).setOnTouchListener(new truckCarMatrix.dragTouchListener());
        findViewById(R.id.option9).setOnDragListener(new truckCarMatrix.dragListener());
        findViewById(R.id.option9).setOnTouchListener(new truckCarMatrix.dragTouchListener());
        findViewById(R.id.option10).setOnDragListener(new truckCarMatrix.dragListener());
        findViewById(R.id.option10).setOnTouchListener(new truckCarMatrix.dragTouchListener());
        findViewById(R.id.option11).setOnDragListener(new truckCarMatrix.dragListener());
        findViewById(R.id.option11).setOnTouchListener(new truckCarMatrix.dragTouchListener());
        findViewById(R.id.option12).setOnDragListener(new truckCarMatrix.dragListener());
        findViewById(R.id.option12).setOnTouchListener(new truckCarMatrix.dragTouchListener());
        findViewById(R.id.option13).setOnDragListener(new truckCarMatrix.dragListener());
        findViewById(R.id.option13).setOnTouchListener(new truckCarMatrix.dragTouchListener());
        findViewById(R.id.option14).setOnDragListener(new truckCarMatrix.dragListener());
        findViewById(R.id.option14).setOnTouchListener(new truckCarMatrix.dragTouchListener());
        findViewById(R.id.option15).setOnDragListener(new truckCarMatrix.dragListener());
        findViewById(R.id.option15).setOnTouchListener(new truckCarMatrix.dragTouchListener());
        findViewById(R.id.option16).setOnDragListener(new truckCarMatrix.dragListener());
        findViewById(R.id.option16).setOnTouchListener(new truckCarMatrix.dragTouchListener());
        findViewById(R.id.bin).setOnDragListener(new truckCarMatrix.dragListener());
        findViewById(R.id.bin).setOnTouchListener(new truckCarMatrix.dragTouchListener());
        findViewById(R.id.placeholder1).setOnDragListener(new truckCarMatrix.dragListener());
        findViewById(R.id.placeholder1).setOnTouchListener(new truckCarMatrix.dragTouchListener());
        findViewById(R.id.placeholder2).setOnDragListener(new truckCarMatrix.dragListener());
        findViewById(R.id.placeholder2).setOnTouchListener(new truckCarMatrix.dragTouchListener());
        findViewById(R.id.placeholder3).setOnDragListener(new truckCarMatrix.dragListener());
        findViewById(R.id.placeholder3).setOnTouchListener(new truckCarMatrix.dragTouchListener());
        findViewById(R.id.placeholder4).setOnDragListener(new truckCarMatrix.dragListener());
        findViewById(R.id.placeholder4).setOnTouchListener(new truckCarMatrix.dragTouchListener());
